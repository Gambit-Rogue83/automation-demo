...
describe("Test the Google homepage", () => {
  ...
  it("can search Google for 'mew' and click on images tab", async() =>{
    await driver.get("https://www.google.com/");
    await driver.findElement(By.name('q')).sendKeys("mew", Key.RETURN)
    await driver.wait(until.titleIs('mew - Google Search'), 1000)
